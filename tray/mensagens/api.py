...
query = f"SELECT id , data_ultima_interacao FROM tray.chat WHERE data_ultima_interacao >= '{data} {hora_anterior}'"
#uery = f"SELECT id , data_ultima_interacao FROM tray.chat WHERE data_ultima_interacao between '2026-03-22 20:00:00' and '2026-03-23 23:59:59'"
...
df_content.to_sql('rawdata_mensagens',con=engine,if_exists='replace',index=False,schema='tray')
