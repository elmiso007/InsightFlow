...
tabela = 'rawdata_chat'
schema = 'tray'  
rotina = "Tray (Carrega Atendimentos Chat)"
...
DDL_URL = "https://o192082-4c6.api001.octadesk.services"
TOKEN = "[REDACTED_TRAY_TOKEN]"
...
def get_interactions(DDL_URL, TOKEN, page):
    ...
    #periodo = '2026-03-17T13%3A00%3A00.300Z'
    ...
    endpoint = f'{DDL_URL}/chat?page={page}&limit={limit}&sort[direction]=desc'

    #endpoint = f'{DDL_URL}/chat?sort[direction]=desc'
...
try:    
    ...
    for page in range(1, 26): 
        ...
        for atendimento in atendimentos:
            ...
            bot_name = atendimento.get('botName')
...
notify_slack_success(f"{total_linhas_inseridas} linhas inseridas e {total_linhas_atualizadas} linhas atualizadas na tabela {table_name}. :tray: ",total_linhas_inseridas,total_linhas_atualizadas, rotina)
