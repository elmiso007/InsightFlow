...
if dia_util:
    ...
    LEFT JOIN (SELECT * FROM depara_chat WHERE ferramenta = 'octadesk') a ON c.grupo_nome = a.skill_lp
    ...
    WHERE data_inicio_interacao BETWEEN '{data_primaria} {hora_30_minutos_atras_formatada}' AND '{data_hoje} {hora_atual_formatada}'       
      AND a.setor = 'Retenção' 
      AND d.dia_util IS {dia_util};
    """
...
if df.empty:
    ...
    tabela = 'rawdata_monitoramento_retencao'
    schema = 'lw_octadesk'
