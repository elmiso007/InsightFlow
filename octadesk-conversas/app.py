...
try:
    ...
    df = pd.read_excel(r'C:\Users\emerson.ramos\Desktop\projetos\octadesk-conversas\Total de conversas.xlsx')
    ...
    with open(r'C:\Users\emerson.ramos\Desktop\projetos\octadesk-conversas\INSERT.sql', 'r', encoding='utf-8') as file:
