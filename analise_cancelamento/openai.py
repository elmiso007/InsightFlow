...
def analise_ia(dataset,data_inicial, data_fim,tarefa,setor):
    ...
    Com base no dataset fornecido, que contém dados de atendimento ao cliente da minha empresa de hospedagem de sites, e-mails e outros serviços, analise os dados e responda às seguintes solicitações. Cada atendimento possui um número de protocolo único e na chave autor consta a informação [cliente], quando a mensagem foi enviada pelo cliente, ou [analista], quando enviada pelo analista.
    ...
    for _ in range(5):
        ...
        if response.status_code == 200:
            ...
            with open(r'C:\Users\emerson.ramos\Desktop\projetos\octadesk_analise_conversas\octadesk_analise_conversas\resposta_openai.md', 'w', encoding='utf-8') as arquivo:
            ...
            #with open(r'C:\Users\lucas.abner\Desktop\Rotinas Python\Chat\Monitoramento\insereDadosAnaliseIA.sql',  'r', encoding='utf-8') as file:
