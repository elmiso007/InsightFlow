...
SELECT 
    ...
    TO_CHAR(c.data_inicio_interacao, 'HH24:MI:SS')::TIME AS hora, -- Isola somente a hora
...
#elif percentual < :
#    print(f"A demanda esta {percentual} abaixo do padrão! Notificando as equipes...")
#    notifica_boas_noticias(hora_30_minutos_atras_formatada_time,hora_formatada_time,percentual)
    notificou = False
else: 
    notificou = False
