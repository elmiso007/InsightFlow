...
SELECT 
    ...
    protocolo::BIGINT,
    agent_id::VARCHAR,
    NULLIF(agent_name::VARCHAR, '') AS agent_name,
    ...
    END AS contact_id,
    CASE 
        WHEN REGEXP_REPLACE(contact_name, '[^\u0000-\u007F]', '', 'g') = agent_name THEN 'Octadesk'
        ELSE 'Cliente'
    END AS iniciado_por,
    tags::TEXT ,
    ...
    grupo_nome::VARCHAR,
    nao_lidas::BOOLEAN,
    'API Octadesk' AS fonte_de_dados,
