...
tabela = 'rawdata'
schema = 'octadesk'  
rotina = "Octadesk (Carrega Atendimentos Chat)"
...
#TOKEN = "75657565-0f17-4044-ab0b-3268d2052a6b.61f258c7-1e05-4110-8894-5c1368791f69"
...
def get_interactions(DDL_URL, TOKEN, page):
    ...
    #periodo = '2025-01-28T14%3A00%3A00.300Z'
    ...
    #endpoint = f"{DDL_URL}/chat?page={page}&limit={limit}&sort[direction]={sort}"
    ...
    response = requests.get(endpoint, headers=headers, timeout=(15, 60))
...
try:
    ...
    for page in range(1, 11): 
        ...
        for atendimento in atendimentos:
            ...
            contact_email = atendimento.get('contact',{}).get('email')
    ...
    with open(r'C:\Users\lucas.abner\Desktop\Rotinas Python\Octadesk\chat\StgInsereDados.sql', 'r', encoding='utf-8') as file:
    ...
    total_linhas_inseridas = 0
    table_name = 'octadesk.chat'
    with open(r'C:\Users\lucas.abner\Desktop\Rotinas Python\Octadesk\chat\InsereDados.sql', 'r', encoding='utf-8') as file:
        query_insercao = text(file.read())
    ...
    with open(r'C:\Users\lucas.abner\Desktop\Rotinas Python\Octadesk\chat\AtualizaDados.sql', 'r', encoding='utf-8') as file:
        query_insercao = text(file.read())
