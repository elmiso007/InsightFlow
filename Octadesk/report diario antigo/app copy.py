...
padrao_fim = pd.to_datetime('2024-12-31 23:59:59')
...
mensagem3 = {
        "blocks": [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "*Obs: O TMA esta sendo calculado considerando os atendimentos encerrados em até 90 minutos. Isto se fez necessário pois ainda não foi implementado o encerramento automático após a falta de interação do cliente.*"
                }
            }
        ]
    }
...
for setor in setores:
    ...
    soma_first_semana_anterior_insta,soma_second_semana_anterior_insta,soma_third_semana_anterior_insta = soma_points(df, canal='Instagram',setor=setor,ultima_semana=True)
    soma_first_semana_anterior_face,soma_second_semana_anterior_face,soma_third_semana_anterior_face = soma_points(df, canal='Facebook-Messenger',setor=setor,ultima_semana=True)
    ...
    soma_first_insta,soma_second_insta,soma_third_insta = soma_points(df, canal='Instagram',setor=setor,ultima_semana=True)
    soma_first_face,soma_second_face,soma_third_face = soma_points(df, canal='Facebook-Messenger',setor=setor,ultima_semana=True)
...
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    tabela = {
        "": ["Padrão Média dia Útil - Jul. a Nov. 2024",
            ...
            f"Instagram D-7 {data_completa_semana_anterior}",
            f"Facebook D-7 {data_completa_semana_anterior}",
            f"Consolidado D-7 {data_completa_semana_anterior}",
            f"WhatsApp {data_completa}",
            f"Chat {data_completa}",
            f"Instagram {data_completa}",
            f"Facebook {data_completa}",
        ...
        "00:00 as 10:00": 
            ...
            soma_first_semana_anterior_insta,
            soma_first_semana_anterior_face,
        ...
        "00:00 as 14:00": 
            ...
            soma_second_semana_anterior_insta,
            soma_second_semana_anterior_face,
        ...
        "00:00 as 18:00": 
            ...
            soma_third_semana_anterior_insta,
            soma_third_semana_anterior_face,
    ...
    table.set_fontsize(9)  # Reduzindo o tamanho da fonte
    table.scale(1.5, 1.5)  # Ajustando a escala da tabela
    ...
    table[6, 0].set_facecolor('#F3A07D')
    table[6, 1].set_facecolor('#F3A07D')
    table[6, 2].set_facecolor('#F3A07D')
    table[6, 3].set_facecolor('#F3A07D')
    ...
    table[11, 0].set_facecolor('#9AC09A')
    table[11, 1].set_facecolor('#9AC09A')
    table[11, 2].set_facecolor('#9AC09A')
    table[11, 3].set_facecolor('#9AC09A')

    #Dados Comparado ao padrão
    table[12, 0].set_facecolor('white')
