...
rotina = "Kinghost (Carrega Pesquisas Chat)"
...
def get_pesquisas(DDL_URL,TOKEN,page):
    ...
    #endpoint = f"{DDL_URL}/survey/submissions?page={page}&limit={limit}?type=chat&isAnswered=true&createdBetween=2025-07-20&createdBetween=2025-07-31"
...
try:    
    ...
    if df_content.empty:
        ...
        notify_slack_success(f"{linhas_inseridas} linhas inseridas na tabela {tabela}.:king:",linhas_inseridas,linhas_atualizadas, rotina)
    else:
        ...
        tabela = 'kinghost_octadesk.pesquisas'
