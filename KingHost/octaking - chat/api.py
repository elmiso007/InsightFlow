...
rotina = "Kinghost (Carrega Atendimentos Chat)"
...
TOKEN = "4067502f-0ccd-4864-adf0-746005206969.84253b97-d987-49ea-83cf-8a3b92ac8867"
...
def get_interactions(DDL_URL, TOKEN, page):
    ...
    #periodo = '2024-07-12T00%3A00%3A00.300Z'
    ...
    #endpoint = f"{DDL_URL}/chat?page={page}&limit={limit}&sort[direction]={sort}&filters[0][property]=updatedAt"
...
try:    
    ...
    for page in range(1, 16): 
        ...
        #todas_atendimentos.extend(atendimentos)
    ...
    # if todas_atendimentos:
    #     json_file = f'{sql_path}/chat.json'
    #     with open(json_file, 'w', encoding='utf-8') as f:
    #         json.dump(todas_atendimentos, f, ensure_ascii=False, indent=4)
    #     print(f"JSON salvo com {len(todas_atendimentos)} registros de todas as páginas")
    ...
    table_name = 'kinghost_octadesk.stgchat'
    ...
    total_linhas_inseridas = 0
    table_name = 'kinghost_octadesk.chat'
...
notify_slack_success(f"{total_linhas_inseridas} linhas inseridas e {total_linhas_atualizadas} linhas atualizadas na tabela {table_name}.:king:",total_linhas_inseridas,total_linhas_atualizadas, rotina)
