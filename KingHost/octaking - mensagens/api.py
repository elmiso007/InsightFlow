...
query = f"SELECT id , data_ultima_interacao FROM kinghost_octadesk.chat WHERE data_ultima_interacao >='{data} {hora_anterior}'"
...
df_content.to_sql('rawdata_messages',con=engine,if_exists='replace',index=False,schema='kinghost_octadesk')
...
try:
    ...
    tabela = 'kinghost_octadesk.mensagens'
    linhas_inseridas = 0
