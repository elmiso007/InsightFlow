...
data_2 = datetime.now()
data_1 = data_2 - timedelta(hours=1)

query = (f"SELECT id, data_ultima_interacao FROM lw_octadesk.chat WHERE data_ultima_interacao >= '{data_1}'")
#query = (f"SELECT id, data_ultima_interacao FROM lw_octadesk.chat WHERE data_ultima_interacao BETWEEN '2025-09-11 00:00:00' AND '2025-09-11 23:59:59'")
