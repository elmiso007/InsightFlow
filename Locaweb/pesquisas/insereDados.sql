INSERT INTO lw_octadesk.pesquisa_de_satisfacao (
    id_pesquisa,
    tipo,
    chat_id,
    respondida,
...
FROM lw_octadesk.rawdata_pesquisas m 
WHERE NOT EXISTS (
    SELECT 1 
    FROM lw_octadesk.pesquisa_de_satisfacao b 
    WHERE b.chat_id = m.chat_id AND b.code = m.code
);